...
export default function CheckList() {
    ...
    return (
        <Container>
            ...
            <br />
            <hr />
            <img style={{ display: "flex", margin: "auto", }} src={img10} />
            <br />
            <Row style={{ flexDirection: "row" }}>
                <Col sm={8} style={{ fontSize: "18px" }}>
    ...
    return (
        <Row key={index} style={index % 2 !== 1 ? { backgroundColor: "#3333", alignItems: "center", padding: "10px 0 10px 0" } : { alignItems: "center", padding: "10px 0 10px 0" }}>
            ...
            <Col sm={8} style={{ display: "flex" }}>
                <Container style={{ border: "solid 4px black", backgroundColor: "white", width: "1%", marginLeft: "10px", marginRight: "20px" }}></Container>
                <p id="itemText" style={{ fontSize: "20px", margin: "10px 0 10px 0" }} dangerouslySetInnerHTML={{ __html: text }}></p>
            </Col>
            {index === 2 ?
                <CardGroup>
