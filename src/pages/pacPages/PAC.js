...
export default function Voter() {
    ...
    const voterLanding = {
        ...
        sidebarTitles: ["Parties List", "Contribution Limits", "List of All Candidates", "List of Party Candidates", "Find Candidates"],
        panelTitles: ["Parties List", "Contribution Limits", "List of All Candidates", "List of Party Candidates", "Find Candidates"],
