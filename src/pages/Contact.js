...
export default function Contact() {
    return (
        <Container style={{ minWidth: "90%", paddingTop: "20px", paddingBottom: "20px", }}>
            ...
            <Row style={{ fontSize: "1.3vw", }}>
                <Col md={6} style={{ borderRight: "1px solid #d3d3d3", paddingRight: "50px", }}>
                    <Card style={{ borderRadius: "15px", border: "5px solid #513A77" }}>
                        <Card.Header className="text-center" style={{ fontWeight: "bold", fontSize: "1.7vw", }}>Contact Smart Voting</Card.Header>
                        <Card.Body style={{ textAlign: "left", padding: "20px", }}>
                            <h4 style={{ fontWeight: "bold", fontSize: "1.4vw",}}>Telephone</h4>
                            <p>647-483-3779</p>
                            <hr />
                            <h4 style={{ fontWeight: "bold", fontSize: "1.4vw", }}>Email</h4>
                            <p>contact@smartvoting.cc</p>
                            <hr />
                            <h4 style={{ fontWeight: "bold", fontSize: "1.4vw",}}>Address - Headquarters</h4>
                ...
                <Col md={6} style={{ paddingLeft: "50px", }}>
                    <Card style={{ borderRadius: "15px", marginBottom: "20px", border: "5px solid #860038" }}>
                        <Card.Header className="text-center" style={{ fontWeight: "bold", fontSize: "1.7vw" }}>Contact Elections Canada</Card.Header>
                        <Card.Body style={{ textAlign: "left", padding: "20px", }}>
                            <h4 style={{ fontWeight: "bold", fontSize: "1.4vw", }}>Telephone</h4>
